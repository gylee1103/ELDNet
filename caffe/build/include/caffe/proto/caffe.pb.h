...
class GenSlicinfoParameter;
class LowlevelDistanceParameter;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.GenSlicinfoParameter gen_slicinfo_param = 999;
  inline bool has_gen_slicinfo_param() const;
  inline void clear_gen_slicinfo_param();
  static const int kGenSlicinfoParamFieldNumber = 999;
  inline const ::caffe::GenSlicinfoParameter& gen_slicinfo_param() const;
  inline ::caffe::GenSlicinfoParameter* mutable_gen_slicinfo_param();
  inline ::caffe::GenSlicinfoParameter* release_gen_slicinfo_param();
  inline void set_allocated_gen_slicinfo_param(::caffe::GenSlicinfoParameter* gen_slicinfo_param);

  // optional .caffe.LowlevelDistanceParameter lowlevel_distance_param = 998;
  inline bool has_lowlevel_distance_param() const;
  inline void clear_lowlevel_distance_param();
  static const int kLowlevelDistanceParamFieldNumber = 998;
  inline const ::caffe::LowlevelDistanceParameter& lowlevel_distance_param() const;
  inline ::caffe::LowlevelDistanceParameter* mutable_lowlevel_distance_param();
  inline ::caffe::LowlevelDistanceParameter* release_lowlevel_distance_param();
  inline void set_allocated_lowlevel_distance_param(::caffe::LowlevelDistanceParameter* lowlevel_distance_param);
 ...
 private:
  ...
  inline void set_has_gen_slicinfo_param();
  inline void clear_has_gen_slicinfo_param();
  inline void set_has_lowlevel_distance_param();
  inline void clear_has_lowlevel_distance_param();
  ...
  ::caffe::GenSlicinfoParameter* gen_slicinfo_param_;
  ::caffe::LowlevelDistanceParameter* lowlevel_distance_param_;
  int phase_;
...
class GenSlicinfoParameter : public ::google::protobuf::Message {
 public:
  GenSlicinfoParameter();
  virtual ~GenSlicinfoParameter();

  GenSlicinfoParameter(const GenSlicinfoParameter& from);

  inline GenSlicinfoParameter& operator=(const GenSlicinfoParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const GenSlicinfoParameter& default_instance();

  void Swap(GenSlicinfoParameter* other);

  // implements Message ----------------------------------------------

  GenSlicinfoParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const GenSlicinfoParameter& from);
  void MergeFrom(const GenSlicinfoParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional uint32 image_size = 1 [default = 324];
  ...
  // optional uint32 slic_size = 2 [default = 18];
  inline bool has_slic_size() const;
  inline void clear_slic_size();
  static const int kSlicSizeFieldNumber = 2;
  inline ::google::protobuf::uint32 slic_size() const;
  inline void set_slic_size(::google::protobuf::uint32 value);

  // optional float coh_weight = 3 [default = 1.4];
  inline bool has_coh_weight() const;
  inline void clear_coh_weight();
  static const int kCohWeightFieldNumber = 3;
  inline float coh_weight() const;
  inline void set_coh_weight(float value);

  // optional bool cielab = 4 [default = true];
  inline bool has_cielab() const;
  inline void clear_cielab();
  static const int kCielabFieldNumber = 4;
  inline bool cielab() const;
  inline void set_cielab(bool value);

  // optional uint32 min_pixel_num = 5 [default = 100];
  inline bool has_min_pixel_num() const;
  inline void clear_min_pixel_num();
  static const int kMinPixelNumFieldNumber = 5;
  inline ::google::protobuf::uint32 min_pixel_num() const;
  inline void set_min_pixel_num(::google::protobuf::uint32 value);

  // @@protoc_insertion_point(class_scope:caffe.GenSlicinfoParameter)
 private:
  inline void set_has_image_size();
  inline void clear_has_image_size();
  inline void set_has_slic_size();
  inline void clear_has_slic_size();
  inline void set_has_coh_weight();
  inline void clear_has_coh_weight();
  inline void set_has_cielab();
  inline void clear_has_cielab();
  inline void set_has_min_pixel_num();
  inline void clear_has_min_pixel_num();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::uint32 image_size_;
  ::google::protobuf::uint32 slic_size_;
  float coh_weight_;
  bool cielab_;
  ::google::protobuf::uint32 min_pixel_num_;
  ...
  void InitAsDefaultInstance();
  static GenSlicinfoParameter* default_instance_;
};
// -------------------------------------------------------------------

class LowlevelDistanceParameter : public ::google::protobuf::Message {
 public:
  LowlevelDistanceParameter();
  virtual ~LowlevelDistanceParameter();

  LowlevelDistanceParameter(const LowlevelDistanceParameter& from);

  inline LowlevelDistanceParameter& operator=(const LowlevelDistanceParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const LowlevelDistanceParameter& default_instance();

  void Swap(LowlevelDistanceParameter* other);

  // implements Message ----------------------------------------------

  LowlevelDistanceParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const LowlevelDistanceParameter& from);
  void MergeFrom(const LowlevelDistanceParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional uint32 feature_option = 4 [default = 0];
  inline bool has_feature_option() const;
  inline void clear_feature_option();
  static const int kFeatureOptionFieldNumber = 4;
  inline ::google::protobuf::uint32 feature_option() const;
  inline void set_feature_option(::google::protobuf::uint32 value);

  // optional uint32 grid_size = 1 [default = 18];
  inline bool has_grid_size() const;
  inline void clear_grid_size();
  static const int kGridSizeFieldNumber = 1;
  inline ::google::protobuf::uint32 grid_size() const;
  inline void set_grid_size(::google::protobuf::uint32 value);

  // optional uint32 train_region_per_image = 2 [default = 9];
  inline bool has_train_region_per_image() const;
  inline void clear_train_region_per_image();
  static const int kTrainRegionPerImageFieldNumber = 2;
  inline ::google::protobuf::uint32 train_region_per_image() const;
  inline void set_train_region_per_image(::google::protobuf::uint32 value);

  // optional uint32 spixel_size = 3 [default = 18];
  inline bool has_spixel_size() const;
  inline void clear_spixel_size();
  static const int kSpixelSizeFieldNumber = 3;
  inline ::google::protobuf::uint32 spixel_size() const;
  inline void set_spixel_size(::google::protobuf::uint32 value);

  // optional bool is_maxpool = 5 [default = true];
  inline bool has_is_maxpool() const;
  inline void clear_is_maxpool();
  static const int kIsMaxpoolFieldNumber = 5;
  inline bool is_maxpool() const;
  inline void set_is_maxpool(bool value);

  // @@protoc_insertion_point(class_scope:caffe.LowlevelDistanceParameter)
 private:
  inline void set_has_feature_option();
  inline void clear_has_feature_option();
  inline void set_has_grid_size();
  inline void clear_has_grid_size();
  inline void set_has_train_region_per_image();
  inline void clear_has_train_region_per_image();
  inline void set_has_spixel_size();
  inline void clear_has_spixel_size();
  inline void set_has_is_maxpool();
  inline void clear_has_is_maxpool();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::uint32 feature_option_;
  ::google::protobuf::uint32 grid_size_;
  ::google::protobuf::uint32 train_region_per_image_;
  ::google::protobuf::uint32 spixel_size_;
  bool is_maxpool_;
  ...
  void InitAsDefaultInstance();
  static LowlevelDistanceParameter* default_instance_;
};
// -------------------------------------------------------------------
...
// optional .caffe.GenSlicinfoParameter gen_slicinfo_param = 999;
inline bool LayerParameter::has_gen_slicinfo_param() const {
  return (_has_bits_[1] & 0x02000000u) != 0;
}
inline void LayerParameter::set_has_gen_slicinfo_param() {
  _has_bits_[1] |= 0x02000000u;
}
inline void LayerParameter::clear_has_gen_slicinfo_param() {
  _has_bits_[1] &= ~0x02000000u;
}
inline void LayerParameter::clear_gen_slicinfo_param() {
  if (gen_slicinfo_param_ != NULL) gen_slicinfo_param_->::caffe::GenSlicinfoParameter::Clear();
  clear_has_gen_slicinfo_param();
}
inline const ::caffe::GenSlicinfoParameter& LayerParameter::gen_slicinfo_param() const {
  return gen_slicinfo_param_ != NULL ? *gen_slicinfo_param_ : *default_instance_->gen_slicinfo_param_;
}
inline ::caffe::GenSlicinfoParameter* LayerParameter::mutable_gen_slicinfo_param() {
  set_has_gen_slicinfo_param();
  if (gen_slicinfo_param_ == NULL) gen_slicinfo_param_ = new ::caffe::GenSlicinfoParameter;
  return gen_slicinfo_param_;
}
inline ::caffe::GenSlicinfoParameter* LayerParameter::release_gen_slicinfo_param() {
  clear_has_gen_slicinfo_param();
  ::caffe::GenSlicinfoParameter* temp = gen_slicinfo_param_;
  gen_slicinfo_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_gen_slicinfo_param(::caffe::GenSlicinfoParameter* gen_slicinfo_param) {
  delete gen_slicinfo_param_;
  gen_slicinfo_param_ = gen_slicinfo_param;
  if (gen_slicinfo_param) {
    set_has_gen_slicinfo_param();
  } else {
    clear_has_gen_slicinfo_param();
  }
...
// optional .caffe.LowlevelDistanceParameter lowlevel_distance_param = 998;
inline bool LayerParameter::has_lowlevel_distance_param() const {
  return (_has_bits_[1] & 0x04000000u) != 0;
}
inline void LayerParameter::set_has_lowlevel_distance_param() {
  _has_bits_[1] |= 0x04000000u;
}
inline void LayerParameter::clear_has_lowlevel_distance_param() {
  _has_bits_[1] &= ~0x04000000u;
}
inline void LayerParameter::clear_lowlevel_distance_param() {
  if (lowlevel_distance_param_ != NULL) lowlevel_distance_param_->::caffe::LowlevelDistanceParameter::Clear();
  clear_has_lowlevel_distance_param();
}
inline const ::caffe::LowlevelDistanceParameter& LayerParameter::lowlevel_distance_param() const {
  return lowlevel_distance_param_ != NULL ? *lowlevel_distance_param_ : *default_instance_->lowlevel_distance_param_;
}
inline ::caffe::LowlevelDistanceParameter* LayerParameter::mutable_lowlevel_distance_param() {
  set_has_lowlevel_distance_param();
  if (lowlevel_distance_param_ == NULL) lowlevel_distance_param_ = new ::caffe::LowlevelDistanceParameter;
  return lowlevel_distance_param_;
}
inline ::caffe::LowlevelDistanceParameter* LayerParameter::release_lowlevel_distance_param() {
  clear_has_lowlevel_distance_param();
  ::caffe::LowlevelDistanceParameter* temp = lowlevel_distance_param_;
  lowlevel_distance_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_lowlevel_distance_param(::caffe::LowlevelDistanceParameter* lowlevel_distance_param) {
  delete lowlevel_distance_param_;
  lowlevel_distance_param_ = lowlevel_distance_param;
  if (lowlevel_distance_param) {
    set_has_lowlevel_distance_param();
  } else {
    clear_has_lowlevel_distance_param();
  }
...
// optional uint32 image_size = 1 [default = 324];
inline bool GenSlicinfoParameter::has_image_size() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void GenSlicinfoParameter::set_has_image_size() {
  _has_bits_[0] |= 0x00000001u;
}
inline void GenSlicinfoParameter::clear_has_image_size() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void GenSlicinfoParameter::clear_image_size() {
  image_size_ = 324u;
  clear_has_image_size();
}
inline ::google::protobuf::uint32 GenSlicinfoParameter::image_size() const {
  return image_size_;
}
inline void GenSlicinfoParameter::set_image_size(::google::protobuf::uint32 value) {
  set_has_image_size();
  image_size_ = value;
}

// optional uint32 slic_size = 2 [default = 18];
inline bool GenSlicinfoParameter::has_slic_size() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void GenSlicinfoParameter::set_has_slic_size() {
  _has_bits_[0] |= 0x00000002u;
}
inline void GenSlicinfoParameter::clear_has_slic_size() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void GenSlicinfoParameter::clear_slic_size() {
  slic_size_ = 18u;
  clear_has_slic_size();
}
inline ::google::protobuf::uint32 GenSlicinfoParameter::slic_size() const {
  return slic_size_;
}
inline void GenSlicinfoParameter::set_slic_size(::google::protobuf::uint32 value) {
  set_has_slic_size();
  slic_size_ = value;
}

// optional float coh_weight = 3 [default = 1.4];
inline bool GenSlicinfoParameter::has_coh_weight() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void GenSlicinfoParameter::set_has_coh_weight() {
  _has_bits_[0] |= 0x00000004u;
}
inline void GenSlicinfoParameter::clear_has_coh_weight() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void GenSlicinfoParameter::clear_coh_weight() {
  coh_weight_ = 1.4f;
  clear_has_coh_weight();
}
inline float GenSlicinfoParameter::coh_weight() const {
  return coh_weight_;
}
inline void GenSlicinfoParameter::set_coh_weight(float value) {
  set_has_coh_weight();
  coh_weight_ = value;
}

// optional bool cielab = 4 [default = true];
inline bool GenSlicinfoParameter::has_cielab() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void GenSlicinfoParameter::set_has_cielab() {
  _has_bits_[0] |= 0x00000008u;
}
inline void GenSlicinfoParameter::clear_has_cielab() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void GenSlicinfoParameter::clear_cielab() {
  cielab_ = true;
  clear_has_cielab();
}
inline bool GenSlicinfoParameter::cielab() const {
  return cielab_;
}
inline void GenSlicinfoParameter::set_cielab(bool value) {
  set_has_cielab();
  cielab_ = value;
}

// optional uint32 min_pixel_num = 5 [default = 100];
inline bool GenSlicinfoParameter::has_min_pixel_num() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void GenSlicinfoParameter::set_has_min_pixel_num() {
  _has_bits_[0] |= 0x00000010u;
}
inline void GenSlicinfoParameter::clear_has_min_pixel_num() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void GenSlicinfoParameter::clear_min_pixel_num() {
  min_pixel_num_ = 100u;
  clear_has_min_pixel_num();
}
inline ::google::protobuf::uint32 GenSlicinfoParameter::min_pixel_num() const {
  return min_pixel_num_;
}
inline void GenSlicinfoParameter::set_min_pixel_num(::google::protobuf::uint32 value) {
  set_has_min_pixel_num();
  min_pixel_num_ = value;
}
...
// optional uint32 feature_option = 4 [default = 0];
inline bool LowlevelDistanceParameter::has_feature_option() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void LowlevelDistanceParameter::set_has_feature_option() {
  _has_bits_[0] |= 0x00000001u;
}
inline void LowlevelDistanceParameter::clear_has_feature_option() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void LowlevelDistanceParameter::clear_feature_option() {
  feature_option_ = 0u;
  clear_has_feature_option();
}
inline ::google::protobuf::uint32 LowlevelDistanceParameter::feature_option() const {
  return feature_option_;
}
inline void LowlevelDistanceParameter::set_feature_option(::google::protobuf::uint32 value) {
  set_has_feature_option();
  feature_option_ = value;
}

// optional uint32 grid_size = 1 [default = 18];
inline bool LowlevelDistanceParameter::has_grid_size() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void LowlevelDistanceParameter::set_has_grid_size() {
  _has_bits_[0] |= 0x00000002u;
}
inline void LowlevelDistanceParameter::clear_has_grid_size() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void LowlevelDistanceParameter::clear_grid_size() {
  grid_size_ = 18u;
  clear_has_grid_size();
}
inline ::google::protobuf::uint32 LowlevelDistanceParameter::grid_size() const {
  return grid_size_;
}
inline void LowlevelDistanceParameter::set_grid_size(::google::protobuf::uint32 value) {
  set_has_grid_size();
  grid_size_ = value;
}

// optional uint32 train_region_per_image = 2 [default = 9];
inline bool LowlevelDistanceParameter::has_train_region_per_image() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void LowlevelDistanceParameter::set_has_train_region_per_image() {
  _has_bits_[0] |= 0x00000004u;
}
inline void LowlevelDistanceParameter::clear_has_train_region_per_image() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void LowlevelDistanceParameter::clear_train_region_per_image() {
  train_region_per_image_ = 9u;
  clear_has_train_region_per_image();
}
inline ::google::protobuf::uint32 LowlevelDistanceParameter::train_region_per_image() const {
  return train_region_per_image_;
}
inline void LowlevelDistanceParameter::set_train_region_per_image(::google::protobuf::uint32 value) {
  set_has_train_region_per_image();
  train_region_per_image_ = value;
}

// optional uint32 spixel_size = 3 [default = 18];
inline bool LowlevelDistanceParameter::has_spixel_size() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void LowlevelDistanceParameter::set_has_spixel_size() {
  _has_bits_[0] |= 0x00000008u;
}
inline void LowlevelDistanceParameter::clear_has_spixel_size() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void LowlevelDistanceParameter::clear_spixel_size() {
  spixel_size_ = 18u;
  clear_has_spixel_size();
}
inline ::google::protobuf::uint32 LowlevelDistanceParameter::spixel_size() const {
  return spixel_size_;
}
inline void LowlevelDistanceParameter::set_spixel_size(::google::protobuf::uint32 value) {
  set_has_spixel_size();
  spixel_size_ = value;
}

// optional bool is_maxpool = 5 [default = true];
inline bool LowlevelDistanceParameter::has_is_maxpool() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void LowlevelDistanceParameter::set_has_is_maxpool() {
  _has_bits_[0] |= 0x00000010u;
}
inline void LowlevelDistanceParameter::clear_has_is_maxpool() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void LowlevelDistanceParameter::clear_is_maxpool() {
  is_maxpool_ = true;
  clear_has_is_maxpool();
}
inline bool LowlevelDistanceParameter::is_maxpool() const {
  return is_maxpool_;
}
inline void LowlevelDistanceParameter::set_is_maxpool(bool value) {
  set_has_is_maxpool();
  is_maxpool_ = value;
}
